...
class ChangePasswordAction extends TestCase
{
    ...
    private function changePassword()
    {
        ...
        try {
            $response = $this->httpClient->post(self::CHGPWD_ENDPOINT,
                array(
                    'form_params' => array(
