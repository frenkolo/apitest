...
class ChangePermissionAction extends TestCase
{
    const USERNAME = 'admin1@gmail.com';
    const PASSWORD = 'fr4n5_$';
    const USERNAME_TO_CHANGE = 'operator1@gmail.com';
    const NEW_ROLE = '1';
    const HTTP_STATUS_SUCCESS = 201;
    CONST LOGIN_ENDPOINT = 'https://admin.gotoeatapp.it/login';
    CONST CHGPERM_ENDPOINT = 'https://admin.gotoeatapp.it/chgpermission';
    ...
    private function changePermission()
    {
        ...
        try {
            $response = $this->httpClient->post(self::CHGPERM_ENDPOINT,
                array(
                    'form_params' => array(
                        'username' => self::USERNAME_TO_CHANGE,
                        'role' => self::NEW_ROLE
                    ),
